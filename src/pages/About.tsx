  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 py-16">
      <div className="container mx-auto px-4 max-w-3xl">
        <h1 className="text-4xl font-bold text-gray-900 mb-8">About Tech Chatter Box</h1>
        <div className="bg-white rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
          <p className="text-gray-600 mb-6 leading-relaxed">
            Welcome to Tech Chatter Box, a community-driven blog dedicated to sharing knowledge, experiences, and insights about software development, design, and technology.
          </p>
          <p className="text-gray-600 mb-6 leading-relaxed">
